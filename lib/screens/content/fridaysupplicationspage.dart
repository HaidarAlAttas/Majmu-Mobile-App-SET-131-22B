...
class FridaySupplicationsPage extends StatefulWidget {
  const FridaySupplicationsPage({super.key});

  @override
  State<FridaySupplicationsPage> createState() =>
      _FridaySupplicationsPageState();
}

class _FridaySupplicationsPageState extends State<FridaySupplicationsPage> {
  ...
  void initState() {
    super.initState();
    futureFolders =
        FirebaseStorage.instance.ref('/fridaysupplication').listAll();
  }
