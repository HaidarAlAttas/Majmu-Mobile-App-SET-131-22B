...
class PostPublicBookmark extends StatefulWidget {
  final String post;
  final String pfp;
  final String user;
  final String postId;
  ...
  @override
  State<PostPublicBookmark> createState() => _PostPublicBookmarkState();
}

class _PostPublicBookmarkState extends State<PostPublicBookmark> {
  ...
  void ToggleBookmarked() async {
    ...
    // access the postPublicBookmark in firebase
    if (isBookmarked == true) {
      // If the post is liked, add the current user's uid from bookmarkedBy[]
      postRef.update({
      ...
      // If the post is unliked, remove the current user's uid from bookmarkedBy[]
      postRef.update({
      ...
      // Call the callback to remove from the UI
      widget.onBookmarkRemoved(widget.postId);
    }
  }
                        ...
                        Column(
                          children: [
                            BookmarkButton(
                              ...
                              onTap: () {
                                print(
                                    'BookmarkButton tapped'); // Debug statement
                                ToggleBookmarked(); // Toggle the bookmark status
                              },
                            ),
                            Text(
